...
public:
		...
		: Enemy("resources/images/buble.png", Vector2(0.0f, 0.0f), Vector2(5000.0f, 5000.0f), 1, 1, 5000, 5000, false, 1, 150.0f, 100)
	{
		...
		AddState(new SimpleMoveState(_transform, _physics, Vector2(-1.0f, 0.0f), 450.0f, RM->WINDOW_WIDTH / 2.0f, true));
		AddState(new StayState(_transform, _physics, Vector2(0.0f, 0.0f), 1.5f));
		AddState(new SimpleMoveState(_transform, _physics, Vector2(1.0f, 0.0f), 450.0f, RM->WINDOW_WIDTH + 50.0f, false));
	}
