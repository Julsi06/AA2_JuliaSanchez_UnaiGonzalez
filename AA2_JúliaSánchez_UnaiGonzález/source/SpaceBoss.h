...
public:
    SpaceBoss(const Vector2& startPos)
        : Enemy("resources/images/SpaceBossAlive.png", Vector2(0.0f, 0.0f), Vector2(6000.0f, 6000.0f), 1, 1, 6000.0f, 6000.0f, false, 1, 1500.0f, 1000.0f)
    {
        GetTransform()->position = startPos;
        GetTransform()->scale = Vector2(5.0f, 4.0f);
