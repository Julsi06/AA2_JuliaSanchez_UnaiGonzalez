...
// We assume all rigidbodies are of 1 unit of mass
class RigidBody
{
private:
...
public:
	RigidBody(Transform* transform)
		: _transform(transform), _velocity(Vector2()), _angularVelocity(0.0f), _acceleration(Vector2()),
		_angularAcceleration(0.0f), _linearDrag(0.0f), _angularDrag(0.0f) { }
	~RigidBody()
	{
