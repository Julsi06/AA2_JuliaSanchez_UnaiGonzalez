...
void BackgroundVine::SetVines(int index)
{
    ...
    {
        // Top vine
        BackgroundVine* topVine1 = new BackgroundVine("resources/images/topVine2.png",
            Vector2(RM->WINDOW_WIDTH / 2.0f, 25.0f), Vector2(1613.0f, 78.0f),
            Vector2(RM->WINDOW_WIDTH, 50.0f));
        _vines.push_back(topVine1);
        SPAWNER.SpawnObject(topVine1);

        BackgroundVine* topVine2 = new BackgroundVine("resources/images/topVine2.png",
            Vector2(RM->WINDOW_WIDTH + topVine1->GetTransform()->position.x, 25.0f),
            Vector2(1613.0f, 78.0f), Vector2(RM->WINDOW_WIDTH, 50.0f));
        _vines.push_back(topVine2);
        SPAWNER.SpawnObject(topVine2);

        // Bottom vine
        BackgroundVine* bottomVine1 = new BackgroundVine("resources/images/bottomVine2.png",
            Vector2(RM->WINDOW_WIDTH / 2.0f, RM->WINDOW_HEIGHT - 150.0f), Vector2(1615.0f, 76.0f),
            Vector2(RM->WINDOW_WIDTH, 60.0f));
        _vines.push_back(bottomVine1);
        SPAWNER.SpawnObject(bottomVine1);

        BackgroundVine* bottomVine2 = new BackgroundVine("resources/images/bottomVine2.png",
            Vector2(RM->WINDOW_WIDTH + bottomVine1->GetTransform()->position.x,
                RM->WINDOW_HEIGHT - 150.0f), Vector2(1615.0f, 76.0f),
            Vector2(RM->WINDOW_WIDTH, 60.0f));
        _vines.push_back(bottomVine2);
        SPAWNER.SpawnObject(bottomVine2);
    }
